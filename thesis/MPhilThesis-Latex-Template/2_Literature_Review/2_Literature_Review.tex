...
Balanced accuracy addresses class imbalance by averaging recall across classes \parencite{chicco_advantages_2020}, ensuring that performance on rare classes contributes equally to the overall metric. For developmental data, where some stages may be underrepresented, balanced accuracy provides a fairer assessment of model performance than simple accuracy.
