...
\begin{table}[H]
  \centering
  \caption{\textbf{Functional annotations of key developmental markers.} Annotations compiled from UniProt, GeneCards, and literature review. All listed genes show conserved developmental expression patterns between pig and human muscle tissue. FC = log$_2$ fold change (infant vs.\ adult). Pig FC derived from pig GTEx data (GEO: GSE257558) \parencite{teng_compendium_2024}; Human FC from \textcite{schaiter_molecular_2024}.}
  \label{tab:S3}
  \footnotesize
  \singlespacing
  \begin{tabularx}{\textwidth}{lXcc}
    ...
    \addlinespace
    \textit{MSS51} & Acts as a skeletal muscle-specific ``brake'' on metabolism, regulating mitochondrial respiration and energy expenditure as muscle fibres differentiate and mature \parencite{rovira_gonzalez_mss51_2019}. & $-$3.02 & $-$1.55 \\
    \addlinespace
