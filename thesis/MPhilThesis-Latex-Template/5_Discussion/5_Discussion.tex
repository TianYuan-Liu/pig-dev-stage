...
First, it presents the first calibrated transcriptomic staging system for pigs, filling a critical gap by providing a complementary approach to existing epigenetic clocks. Second, it demonstrates that cross-tissue feature overlap is 180-fold lower than random expectation, providing quantitative evidence for the tissue-specificity of postnatal development. Third, the cross-species analysis provides the first systematic comparison of postnatal developmental trajectories between pig and human muscle, supporting the pig's validity as a translational model. Finally, the analytical framework developed for this thesis is open-source, enabling other researchers to apply and extend the approach.
...
One of the most striking findings of this thesis is the profound tissue-specificity of developmental gene expression programs. The cross-tissue feature overlap of only 0.3\%---180-fold lower than the 55\% expected by chance---indicates that each tissue follows a largely independent developmental trajectory.
...
\textbf{Asynchronous tissue maturation.} The distinct gene sets underlying development in different tissues provide a molecular basis for the asynchronous maturation observed at the physiological level. Different tissues can proceed through their developmental programs at different rates because these programs involve different genes.
...
The biological basis for tissue-specific developmental programs likely involves tissue-specific transcription factor networks that activate distinct downstream targets in each tissue. These networks have been shaped by evolution to control the maturation of tissue-specific functions, leading to divergent developmental gene sets.
...
The conserved upregulation of SORCS2, ACHE, and KREMEN1 during development points to the importance of neuromuscular junction maturation as a conserved developmental process. SORCS2 is a neurotrophin receptor that regulates the trafficking of signalling receptors, influencing the balance between neuronal growth and pruning \parencite{thomasen_sorcs2_2023}. Its upregulation during development may reflect the refinement of motor neuron innervation patterns.

ACHE (acetylcholinesterase) is essential for terminating synaptic transmission at the neuromuscular junction. Its developmental upregulation in both species suggests that the establishment of efficient neuromuscular transmission is a conserved aspect of postnatal muscle development.

KREMEN1 is a negative regulator of Wnt signalling that partners with DKK1 to control cell survival and tissue patterning \parencite{osada_wnt_2006}. Its developmental upregulation may reflect the dampening of growth-promoting pathways as tissues mature.

\subsubsection{Structural Refinement Module}

The upregulation of FGFRL1 in both species is particularly noteworthy given its role as a decoy receptor that attenuates FGF signalling. The dampening of growth factor signalling during development may be a conserved mechanism for transitioning from proliferative growth to tissue homeostasis \parencite{amann_fgfrl1_2014}.

\subsubsection{Metabolic Transition Module}

The downregulation of MSS51 during development in both species is consistent with its role as a skeletal muscle-specific ``brake'' on metabolism \parencite{rovira_gonzalez_mss51_nodate}. MSS51 restricts mitochondrial respiration, and its downregulation releases this restriction, enabling the establishment of mature oxidative capacity. This metabolic transition appears to be a conserved feature of postnatal muscle development.
...
\textbf{Circadian regulation in liver.} The prominence of circadian clock genes (NPAS2, BHLHE41) among liver markers suggests that the establishment of circadian metabolic rhythms is a key aspect of hepatic development. This aligns with the known importance of circadian regulation for hepatic function in adult animals.

\textbf{Epigenetic regulation in brain.} The identification of DNMT3L and HDAC6 as brain markers points to the role of epigenetic mechanisms in neural development. DNA methylation and histone modification are known to be dynamically regulated during brain development, establishing stable patterns of gene expression that underlie neural function.

\textbf{Immune development in lung and blood.} The prominence of immune-related genes (GFI1, IL-6 pathway components) among lung and blood markers reflects the establishment of immune competence during postnatal life. The lung, in particular, must develop robust immune defences as it is exposed to environmental antigens from birth.

\textbf{Contractile and metabolic function in muscle.} Muscle markers reflect both the structural (TRDN, PDLIM3) and metabolic (MSS51) aspects of muscle development, capturing the establishment of mature contractile and oxidative function.
...
Nutrition research represents a major application area for pig research, as pigs are widely used to model human dietary responses. Developmental stage is a critical variable in nutrition studies because nutrient requirements, digestive capacity, and metabolic responses all change during postnatal development.
...
Pigs are increasingly used as disease models, including models for cardiovascular disease, diabetes, cancer, and infectious disease. Many diseases have developmental components, with susceptibility or progression varying with developmental stage.
