...
Confidence intervals for all metrics were computed using bootstrap resampling \parencite{efron_bootstrap_1979}. The procedure involved resampling the test set with replacement to create a bootstrap sample of the same size, computing the metric on this sample, and repeating the process for 1,000 iterations. The 2.5th and 97.5th percentiles of the resulting distribution were then taken to obtain the 95\% confidence intervals.
