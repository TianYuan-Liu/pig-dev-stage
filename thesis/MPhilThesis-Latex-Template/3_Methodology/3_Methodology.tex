...
The Benjamini-Hochberg procedure was applied to control the false discovery rate (FDR) at 5\%. This procedure orders $p$-values from smallest to largest and rejects hypotheses for which:
